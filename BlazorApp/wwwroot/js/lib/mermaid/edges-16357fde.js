import {A as j, b7 as Q, c as b, d as q, F as lt, j as B, l as g, p as H} from "./mermaid-9f2aa176.js";
...
function kt(e) {
    const t = B(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), a = t.append("xhtml:div"),
        i = e.label, l = e.isNode ? "nodeLabel" : "edgeLabel";
    return a.html(
...
const vt = (e, t, a, i) => {
    ...
    const s = e.insert("g").attr("class", l).attr("id", t.domId || t.id),
    ...
    return r ? n.attr("transform", "translate(" + -y.width / 2 + ", " + -y.height / 2 + ")") : n.attr("transform", "translate(0, " + -y.height / 2 + ")"), t.centerLabel && n.attr("transform", "translate(" + -y.width / 2 + ", " + -y.height / 2 + ")"), n.insert("rect", ":first-child"), {
        shapeSvg: s,
        bbox: y,
        halfPadding: p,
        label: n
...
function it(e, t, a, i) {
    var l = e.x, r = e.y, s = l - i.x, n = r - i.y, c = Math.sqrt(t * t * n * n + a * a * s * s),
        o = Math.abs(t * a * s / c);
    i.x < l && (o = -o);
...
function Mt(e, t, a, i) {
    ...
    if (l = t.y - e.y, s = e.x - t.x, c = t.x * e.y - e.x * t.y, p = l * a.x + s * a.y + c, f = l * i.x + s * i.y + c, !(p !== 0 && f !== 0 && J(p, f)) && (r = i.y - a.y, n = a.x - i.x, o = i.x * a.y - a.x * i.y, h = r * e.x + n * e.y + o, y = r * t.x + n * t.y + o, !(h !== 0 && y !== 0 && J(h, y)) && (x = l * n - r * s, x !== 0)))
        return k = Math.abs(x / 2), d = s * o - n * c, u = d < 0 ? (d - k) / x : (d + k) / x, d = r * c - l * o, S = d < 0 ? (d - k) / x : (d + k) / x, {
            x: u,
            y: S
        };
}
...
function Tt(e, t, a) {
    ...
    return r.length ? (r.length > 1 && r.sort(function (x, k) {
        var d = x.x - a.x, u = x.y - a.y, S = Math.sqrt(d * d + u * u), E = k.x - a.x, C = k.y - a.y,
            W = Math.sqrt(E * E + C * C);
...
const Et = (e, t) => {
    ...
    const {shapeSvg: a, bbox: i} = await M(e, t, void 0, !0), l = 2, r = i.height + 2 * t.padding, s = r / l,
        n = i.width + 2 * s + t.padding, c = Rt(t.directions, i, t), o = I(a, n, r, c);
    return o.attr("style", t.style), m(t, o), t.intersect = function (h) {
        return w.polygon(t, c, h);
    }, a;
}, Ot = async (e, t) => {
    ...
    const {shapeSvg: a, bbox: i} = await M(
            ...
            _(t, void 0),
            !0
        ), l = i.width + t.padding, r = l / 2, s = r / (2.5 + l / 50), n = i.height + s + t.padding,
        c = "M 0," + s + " a " + r + "," + s + " 0,0,0 " + l + " 0 a " + r + "," + s + " 0,0,0 " + -l + " 0 l 0," + n + " a " + r + "," + s + " 0,0,0 " + l + " 0 l 0," + -n,
        o = a.attr("label-offset-y", s).insert("path", ":first-child").attr("style", t.style).attr("d", c).attr("transform", "translate(" + -l / 2 + "," + -(n / 2 + s) + ")");
    ...
    const {shapeSvg: a, bbox: i, halfPadding: l} = await M(
            ...
            !0
        ), r = a.insert("rect", ":first-child"), s = t.positioned ? t.width : i.width + t.padding,
        n = t.positioned ? t.height : i.height + t.padding, c = t.positioned ? -s / 2 : -i.width / 2 - l,
...
const Gt = (e, t) => {
    ...
    const i = e.insert("g").attr("class", a).attr("id", t.domId || t.id), l = i.insert("rect", ":first-child"),
        r = i.insert("line"), s = i.insert("g").attr("class", "label"),
    ...
    const {shapeSvg: a, bbox: i} = await M(
            ...
            _(t, void 0),
            !0
        ), l = i.height + t.padding, r = i.width + l / 4 + t.padding,
        s = a.insert("rect", ":first-child").attr("style", t.style).attr("rx", l / 2).attr("ry", l / 2).attr("x", -r / 2).attr("y", -l / 2).attr("width", r).attr("height", l);
    ...
    const a = e.insert("g").attr("class", "node default").attr("id", t.domId || t.id),
        i = a.insert("circle", ":first-child"), l = a.insert("circle", ":first-child");
    ...
    const s = e.insert("g").attr("class", r).attr("id", t.domId || t.id), n = s.insert("rect", ":first-child"),
        c = s.insert("line"), o = s.insert("line");
    let h = 0, y = i;
    const p = s.insert("g").attr("class", "label");
    let f = 0;
    const x = t.classData.annotations && t.classData.annotations[0],
        k = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "",
        d = p.node().appendChild(R(k, t.labelStyle, !0, !0));
    let u = d.getBBox();
    if (H(b().flowchart.htmlLabels)) {
...
const or = async (e, t, a) => {
    ...
    var l, r;
    const t = ((l = e == null ? void 0 : e.subGraphTitleMargin) == null ? void 0 : l.top) ?? 0,
        a = ((r = e == null ? void 0 : e.subGraphTitleMargin) == null ? void 0 : r.bottom) ?? 0, i = t + a;
    return {
...
const dr = () => {
    ...
    const a = H(b().flowchart.htmlLabels), i = t.labelType === "markdown" ? st(e, t.label, {
            ...
            useHtmlLabels: a,
            addSvgBackground: !0
        }) : R(t.label, t.labelStyle), l = e.insert("g").attr("class", "edgeLabel"),
    ...
    let n;
    if (t.startLabelLeft) {
        const c = R(t.startLabelLeft, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"),
    ...
    if (t.startLabelRight) {
        const c = R(t.startLabelRight, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"),
            h = o.insert("g").attr("class", "inner");
    ...
    if (t.endLabelLeft) {
        const c = R(t.endLabelLeft, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"),
            h = o.insert("g").attr("class", "inner");
        n = h.node().appendChild(c);
        const y = c.getBBox();
    ...
    if (t.endLabelRight) {
        const c = R(t.endLabelRight, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"),
            h = o.insert("g").attr("class", "inner");
        n = h.node().appendChild(c);
        const y = c.getBBox();
...
const gr = (e, t) => {
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(l - t.y) * s > Math.abs(i - t.x) * c) {
        ...
        return g.debug(`sides calc abc89, Q ${o}, q ${y}, R ${h}, r ${n}`, {
            _x: p,
            _y: f
        }), n === 0 && (p = t.x, f = t.y), h === 0 && (p = t.x), o === 0 && (f = t.y), {x: p, y: f};
    }
}, et = (e, t) => {
