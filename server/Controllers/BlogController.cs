 ...
 private  void PodList()
{
    ...
    //
    // var certPem = System.IO.File.ReadAllText("cert.pem");
    // var eccPem = System.IO.File.ReadAllText("ecc.pem");
    ...
    var httpResponseMessage = client.GetAsync("https://kubernetes.docker.internal:6443/api/v1/namespaces/guestbook/pods").GetAwaiter().GetResult();
